    ...
    <>
      <div className="min-h-full">
        ...
        <div className="hidden lg:fixed lg:inset-y-0 lg:flex lg:w-64 lg:flex-col">
          ...
          <div className="flex flex-grow flex-col overflow-y-auto bg-cyan-900 pt-20 pb-5">
            <nav
              className="mt-5 flex flex-1 flex-col divide-y divide-cyan-800 overflow-y-auto scrollbar scrollbar-thumb-cyan-800"
              aria-label="Sidebar">
