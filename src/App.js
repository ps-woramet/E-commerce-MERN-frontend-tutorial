    ...
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path="admin" element={<AdminRoute><AdminDashboard /></AdminRoute>}>
          ...
          <Route path="products/edit/:id" element={<AdminRoute><ProductUpdate /></AdminRoute>} />
          {/* coupons */}
          <Route path="add-coupon" element={<AdminRoute><AddCoupon /></AdminRoute>} />
          <Route path="manage-coupon" element={<AdminRoute><ManageCoupons /> </AdminRoute>}/>
          ...
          <Route path="all-brands" element={<AdminRoute><BrandsList /> </AdminRoute>}/>
          {/* color category */}
          <Route path="add-color" element={<AdminRoute><AddColor /></AdminRoute>} />
          <Route path="all-colors" element={<AdminRoute><ColorsList /> </AdminRoute>}/>
          {/* Orders */}
